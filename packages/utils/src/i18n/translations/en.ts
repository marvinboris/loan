export const en = {
  ...
  privacy_policy: {
    ...
    content: `
The following Privacy Policy describes how we, Credit Wave and its Affiliates, collect, store, use, transfer, disclose and protect your Personal Information.
...
Your Personal Information may be transferred to, stored, used and processed in a jurisdiction other than your home country or otherwise in the country, state and city in which you are located while using any Service provided by us ("Alternate Country") Credit Wave companies under Our Group which are outside your country or Foreign Country and/or where our Credit Wave group servers and/or service providers and partners are outside your country or Foreign Country.
...
If you have any questions about this Privacy Policy or would like to access and/or make corrections to your Personal Information, please contact us atCredit Wave@gmail.com
    `,
  },
  about_us: {
    title: 'About us',
    content: `1. About these Terms of Use
Please read these Terms of Use very carefully. These Terms and Conditions constitute the electronic financial service and end user license agreement, and by registering or using any part of the Credit Wave service (“Service”), You confirm that You have read, understood, accepted and agree to these Terms of Use and shall be bound by it. If you do not agree to be bound by these Terms, You may not access or use any part of the Service. These Terms and Conditions constitute a binding legal agreement between You, as an individual user (“You” or “Your”) and Credit Wave (“We”, “Us” or “Our”).
...
System means the Credit Wave system provided by Us to provide users with the Services, including the Software and related programs, Websites, systems and other support systems and services.
...
4.9 You authorize Credit Wave to use the payment method with automatic deduction if you fail to repay the loan on the agreed repayment date by submitting this bank card confirmation.
...
18.10 We may give you notice through a general notice posted on the App or Platform or to your email address set forth in Your Account. You must give us notice by email to:Credit Wave@gmail.com
18.11 All complaints and suggestions related to the System and Services can be made by sending an email to: Credit Wave@gmail.com
    `,
  },
  language: {
    title: 'Language',
